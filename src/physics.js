...
/**
 * @typedef { import("./models/physics.js").PhysicsInterface } PhysicsType
 */
/** @implements {PhysicsType} */
export class Physics {
     ...
     * @returns {BlockCollisionInterface[]}
     */
     ...
     * @param {BlockCollisionInterface[]} candidates
     * @param {Player} player
     * @returns {BlockCollisionInterface[]}
     */
